...
{
   numOutputted_ = 0;
   isInCheck_ = tgen_.isInCheck(state_.active_);
...
void MoveGenerator<OutputIt>::genWCastles()
{
   if (state_.canWhiteShortCastle_ && 
      ...
      !tgen_.isAttacked(Sq::f1, Colour::Black) &&
      !tgen_.isAttacked(Sq::g1, Colour::Black))
   {
   ...
   if(state_.canWhiteLongCastle_&& 
      ...
      !tgen_.isAttacked(Sq::d1, Colour::Black) &&
      !tgen_.isAttacked(Sq::c1, Colour::Black))
   {
...
void MoveGenerator<OutputIt>::genBCastles()
{
   if (state_.canBlackShortCastle_ && 
      ...
      !tgen_.isAttacked(Sq::f8, Colour::White) &&
      !tgen_.isAttacked(Sq::g8, Colour::White))
   {
   ...
   if(state_.canBlackLongCastle_&& 
      ...
      !tgen_.isAttacked(Sq::d8, Colour::White) &&
      !tgen_.isAttacked(Sq::c8, Colour::White))
   {
