...
TEST(PerfTest, perft1) 
{
   ...
   // ASSERT_EQ(perft(g, 5), 4865609);  // ~4 s
    ASSERT_EQ(perft(g, 6), 119060324); // ~80 s
...
// // //=============================================================================
// // TEST(PerfTest, perftdebug) 
// // {
// //    Board b;
// //    State s;
// //    setBoard1(b, s);
// //    Game g(b, s);
// //    g.move(Move{Sq::f2, Sq::f4, MoveType::DoubleAdvance});
// //    g.move(Move{Sq::e4, Sq::f3, MoveType::EnPassant, Piece::Pawn});
// //    ASSERT_EQ(perft(g, 1), 32);
// // }
