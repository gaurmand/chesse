...
TEST(MoveExecutorTest, NormalMove) 
{
   ...
   EXPECT_EQ(b.pieceAt(Sq::h8), PieceType::Knight);
   EXPECT_EQ(b.colourAt(Sq::h8), Colour::White);
   EXPECT_EQ(b.pieceAt(Sq::g6), PieceType::Empty);
   ...
   exec.move(m);
   EXPECT_EQ(b.pieceAt(Sq::h8), PieceType::Empty);
   EXPECT_EQ(b.colourAt(Sq::h8), Colour::Empty);
   EXPECT_EQ(b.pieceAt(Sq::g6), PieceType::Knight);
   ...
   m = Move{Sq::g4, Sq::d1, MoveType::Normal, PieceType::Rook};
   EXPECT_EQ(b.pieceAt(Sq::g4), PieceType::Bishop);
   EXPECT_EQ(b.colourAt(Sq::g4), Colour::Black);
   EXPECT_EQ(b.pieceAt(Sq::d1), PieceType::Rook);
   ...
   EXPECT_EQ(s.fullMoveClock_, 8);
   exec.move(m);
   EXPECT_EQ(b.pieceAt(Sq::g4), PieceType::Empty);
   EXPECT_EQ(b.colourAt(Sq::g4), Colour::Empty);
   EXPECT_EQ(b.pieceAt(Sq::d1), PieceType::Bishop);
...
TEST(MoveExecutorTest, Castle) 
{
   ...
   EXPECT_EQ(s.fullMoveClock_, 8);
   exec.move(m);
   EXPECT_EQ(b.pieceAt(Sq::e1), PieceType::Empty);
   EXPECT_EQ(b.colourAt(Sq::e1), Colour::Empty);
   EXPECT_EQ(b.pieceAt(Sq::g1), PieceType::King);
   EXPECT_EQ(b.colourAt(Sq::g1), Colour::White);
   EXPECT_EQ(b.pieceAt(Sq::h1), PieceType::Empty);
   EXPECT_EQ(b.colourAt(Sq::h1), Colour::Empty);
   EXPECT_EQ(b.pieceAt(Sq::f1), PieceType::Rook);
   ...
   EXPECT_EQ(s.fullMoveClock_, 8);
   exec.move(m);
   EXPECT_EQ(b.pieceAt(Sq::e8), PieceType::Empty);
   EXPECT_EQ(b.colourAt(Sq::e8), Colour::Empty);
   EXPECT_EQ(b.pieceAt(Sq::c8), PieceType::King);
   EXPECT_EQ(b.colourAt(Sq::c8), Colour::Black);
   EXPECT_EQ(b.pieceAt(Sq::a8), PieceType::Empty);
   EXPECT_EQ(b.colourAt(Sq::a8), Colour::Empty);
   EXPECT_EQ(b.pieceAt(Sq::d8), PieceType::Rook);
...
TEST(MoveExecutorTest, EnPassant) 
{
   ...
   EXPECT_EQ(b.pieceAt(Sq::c5), PieceType::Pawn);
   EXPECT_EQ(b.colourAt(Sq::c5), Colour::White);
   EXPECT_EQ(b.pieceAt(Sq::b6), PieceType::Empty);
   EXPECT_EQ(b.colourAt(Sq::b6), Colour::Empty);
   EXPECT_EQ(b.pieceAt(Sq::b5), PieceType::Pawn);
   ...
   EXPECT_EQ(s.fullMoveClock_, 8);
   exec.move(m);
   EXPECT_EQ(b.pieceAt(Sq::c5), PieceType::Empty);
   EXPECT_EQ(b.colourAt(Sq::c5), Colour::Empty);
   EXPECT_EQ(b.pieceAt(Sq::b6), PieceType::Pawn);
   EXPECT_EQ(b.colourAt(Sq::b6), Colour::White);
   EXPECT_EQ(b.pieceAt(Sq::b5), PieceType::Empty);
   ...
   m = Move{Sq::e4, Sq::f3, MoveType::EnPassant, PieceType::Pawn};
   EXPECT_EQ(b.pieceAt(Sq::e4), PieceType::Pawn);
   EXPECT_EQ(b.colourAt(Sq::e4), Colour::Black);
   EXPECT_EQ(b.pieceAt(Sq::f3), PieceType::Empty);
   EXPECT_EQ(b.colourAt(Sq::f3), Colour::Empty);
   EXPECT_EQ(b.pieceAt(Sq::f4), PieceType::Pawn);
   ...
   exec.move(m);
   EXPECT_EQ(b.pieceAt(Sq::e4), PieceType::Empty);
   EXPECT_EQ(b.colourAt(Sq::e4), Colour::Empty);
   EXPECT_EQ(b.pieceAt(Sq::f3), PieceType::Pawn);
   EXPECT_EQ(b.colourAt(Sq::f3), Colour::Black);
   EXPECT_EQ(b.pieceAt(Sq::f4), PieceType::Empty);
...
TEST(MoveExecutorTest, DoubleAdvance) 
{
   ...
   EXPECT_EQ(b.pieceAt(Sq::e2), PieceType::Pawn);
   ...
   exec.move(m);
   EXPECT_EQ(b.pieceAt(Sq::e2), PieceType::Empty);
   ...
   EXPECT_EQ(b.pieceAt(Sq::d7), PieceType::Pawn);
   EXPECT_EQ(b.colourAt(Sq::d7), Colour::Black);
   EXPECT_EQ(b.pieceAt(Sq::d5), PieceType::Empty);
   ...
   EXPECT_EQ(s.fullMoveClock_, 0);
   exec.move(m);
   EXPECT_EQ(b.pieceAt(Sq::d7), PieceType::Empty);
   EXPECT_EQ(b.colourAt(Sq::d7), Colour::Empty);
   EXPECT_EQ(b.pieceAt(Sq::d5), PieceType::Pawn);
...
TEST(MoveExecutorTest, Promotion) 
{
   ...
   Move m{Sq::b2, Sq::a1, MoveType::KnightPromotion, PieceType::Rook};
   EXPECT_EQ(b.pieceAt(Sq::b2), PieceType::Pawn);
   ...
   exec.move(m);
   EXPECT_EQ(b.pieceAt(Sq::b2), PieceType::Empty);
   EXPECT_EQ(b.colourAt(Sq::b2), Colour::Empty);
   EXPECT_EQ(b.pieceAt(Sq::a1), PieceType::Knight);
   ...
   EXPECT_EQ(b.pieceAt(Sq::g7), PieceType::Pawn);
   EXPECT_EQ(b.colourAt(Sq::g7), Colour::White);
   EXPECT_EQ(b.pieceAt(Sq::g8), PieceType::Empty);
   ...
   EXPECT_EQ(s.fullMoveClock_, 32);
   exec.move(m);
   EXPECT_EQ(b.pieceAt(Sq::g7), PieceType::Empty);
   EXPECT_EQ(b.colourAt(Sq::g7), Colour::Empty);
   EXPECT_EQ(b.pieceAt(Sq::g8), PieceType::Queen);
